// Package claude renders normalized packages for the Claude target.
package claude
...
// Adapter renders packages using the Claude target-neutral baseline.
type Adapter struct{}
...
// Capabilities returns the Claude capability rules.
...
// Render renders packages into one deterministic Claude target plan.
...
// Render renders packages using a new Claude adapter.
