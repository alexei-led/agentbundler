// Package grok renders normalized packages for the Grok target.
package grok
...
// Adapter renders packages using the Grok target-neutral baseline.
type Adapter struct{}
...
// Capabilities returns the Grok capability rules.
...
// Render renders packages into one deterministic Grok target plan.
...
// Render renders packages using a new Grok adapter.
