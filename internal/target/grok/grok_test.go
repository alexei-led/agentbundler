...
func TestRenderUsesGrokNativeSkillRoot(t *testing.T) {
	...
	if got, want := []model.RelativePath{plan.Files[0].Path, plan.Files[1].Path}, []model.RelativePath{".grok/skills/guide/SKILL.md", ".grok/skills/guide/docs/readme.md"}; !reflect.DeepEqual(got, want) {
