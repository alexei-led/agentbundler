// Package pi renders normalized packages for the Pi target.
package pi
...
// Adapter renders packages using the Pi target-neutral baseline.
type Adapter struct{}
...
// Capabilities returns the Pi capability rules.
...
// Render renders packages into one deterministic Pi target plan.
...
// Render renders packages using a new Pi adapter.
